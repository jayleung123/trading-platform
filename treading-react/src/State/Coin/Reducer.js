import { FETCH_COIN_LIST_REQUEST, FETCH_COIN_BY_ID_REQUEST, FETCH_COIN_DETAILS_REQUEST, SEARCH_COIN_REQUEST, FETCH_TOP_50_COINS_REQUEST, FETCH_MARKET_CHART_REQUEST, FETCH_COIN_LIST_SUCCESS, FETCH_MARKET_CHART_SUCCESS, FETCH_TOP_50_COINS_SUCCESS, FETCH_COIN_BY_ID_SUCCESS, SEARCH_COIN_SUCCESS, FETCH_COIN_DETAILS_SUCCESS, FETCH_MARKET_CHART_FAILURE, FETCH_COIN_LIST_FAILURE, FETCH_COIN_BY_ID_FAILURE, SEARCH_COIN_FAILURE, FETCH_COIN_DETAILS_FAILURE, FETCH_TOP_50_COINS_FAILURE } from "./ActionType";
...
const coinReducer = (state = initialState, action) => {
    switch (action.type) {
        ...
        case FETCH_MARKET_CHART_REQUEST:
            return{...state, marketChart: {laoding: true, data: []}, error:null}
