...
import com.jay.treading.domain.PaymentOrderStatus;
import com.jay.treading.modal.PaymentOrder;
import com.jay.treading.modal.User;
import com.jay.treading.repository.PaymentOrderRepository;
...
public class PaymentServiceImpl implements PaymentService{
    ...
    public Boolean proceedPaymentOrder(PaymentOrder paymentOrder, String paymentId) throws RazorpayException {
        ...
        if(paymentOrder.getStatus().equals(PaymentOrderStatus.PENDING)) {
            ...
            if(paymentOrder.getPaymentMethod().equals(PaymentMethod.RAZORPAY)) {
                RazorpayClient razorpay = new RazorpayClient(apiKey, apiSecretKet);
    ...
    public PaymentResponse createRazorpayPaymentLink(User user, Long amount) throws RazorpayException {
        ...
        try {
            ...
            paymentLinkRequest.put("callback_url", "http://localhost:5454/wallet");
